...
def get_ptv_update():
    ...
    ptv_status = Machines.get_current_status()
    return render_template(
        "manufacturing/ptv_screen.html", ptv_status=ptv_status
    )
...
def plot_historical_data():
    ...
    return render_template(
        "manufacturing/machine_history_graphs.html", plot=plot
    )
