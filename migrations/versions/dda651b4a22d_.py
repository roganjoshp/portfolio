...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["machine_id"],
            ["machines.id"],
            name=op.f("fk_current_machine_status_machine_id_machines"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_current_machine_status")),
    )
    with op.batch_alter_table(
        "current_machine_status", schema=None
    ) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_current_machine_status_machine_id"),
            ["machine_id"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["machine_id"],
            ["machines.id"],
            name=op.f("fk_machine_history_machine_id_machines"),
            ondelete="CASCADE",
        ),
    ...
    with op.batch_alter_table("machine_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_machine_history_datetime"),
            ["datetime"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_machine_history_machine_id"),
            ["machine_id"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["machine_id"],
            ["machines.id"],
            name=op.f("fk_machine_stats_machine_id_machines"),
            ondelete="CASCADE",
        ),
    ...
    with op.batch_alter_table("machine_stats", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_machine_stats_machine_id"),
            ["machine_id"],
            unique=False,
        )
